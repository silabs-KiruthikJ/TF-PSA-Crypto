...
#if defined(PSA_WANT_ALG_SPAKE2_P)
#if !defined(MBEDTLS_PSA_ACCEL_ALG_SPAKE2_P)
#define MBEDTLS_PSA_BUILTIN_ALG_SPAKE2_P 1
#define MBEDTLS_PSA_BUILTIN_PAKE 1
#define MBEDTLS_PSA_BUILTIN_KEY_TYPE_PASSWORD 1
#define MBEDTLS_BIGNUM_C
#define MBEDTLS_ECP_C
#define MBEDTLS_ECP_DP_SECP256R1_ENABLED
#define MBEDTLS_SHA256_C
#define MBEDTLS_SPAKE2_C
#endif /* !MBEDTLS_PSA_ACCEL_ALG_SPAKE2_P */
#endif /* PSA_WANT_ALG_SPAKE2_P */
...
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_SPAKE2P_KEY_PAIR_IMPORT)
#define MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_KEY_PAIR_IMPORT 1
#endif /* missing accel */
#endif /* PSA_WANT_KEY_TYPE_SPAKE2P_KEY_PAIR_IMPORT */

#if defined(PSA_WANT_KEY_TYPE_SPAKE2P_KEY_PAIR_EXPORT)
#if !defined(MBEDTLS_PSA_ACCEL_KEY_TYPE_SPAKE2P_KEY_PAIR_EXPORT)
#define MBEDTLS_PSA_BUILTIN_KEY_TYPE_SPAKE2P_KEY_PAIR_EXPORT 1
#endif /* missing accel */
#endif /* PSA_WANT_KEY_TYPE_SPAKE2P_KEY_PAIR_EXPORT */
